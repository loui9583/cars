...
class CarRepositoryTest {
    ...
    @Test
    public void testFindAllCarsByBrandAndModel() {
        carRepository.save(new Car("Toyota", "Camry", 150, 10));
        carRepository.save(new Car("BMW", "M3", 200, 20));
        carRepository.save(new Car("BMW", "M3", 200, 20));

        assertEquals(1, carRepository.findByBrandAndModel("Toyota", "Camry").size());
        assertEquals(2, carRepository.findByBrandAndModel("BMW", "M3").size());
    }
}
